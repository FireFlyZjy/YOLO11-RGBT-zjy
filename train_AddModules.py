...
# --- 模型配置 ---
# 模型 YAML 配置文件路径
DEFAULT_MODEL_YAML = "ultralytics/cfg/models/26-RGBT/2026-06-04/frequency/yolo26-RGBT-midfusion-vHeat_Block.yaml"

# --- 训练结果保存 ---
DEFAULT_PROJECT = "runs/FLIR/26dual-test"
DEFAULT_NAME = "yolo26s-RGBT-midfusion-vHeat_Block"
